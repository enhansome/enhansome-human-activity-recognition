...
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,439 | 🐛 234 | 🌐 Python | 📅 2026-08-31 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [SMPL-X](https://github.com/vchoutas/smplx) ⭐ 2,691 | 🐛 134 | 🌐 Python | 📅 2024-08-12 - Expressive body model capturing body, face, and hand poses, the standard for modern motion datasets.
* [MotionGPT](https://github.com/OpenMotionLab/MotionGPT) ⭐ 1,962 | 🐛 72 | 🌐 Python | 📅 2025-07-01 - Unified motion-language generation model treating motion as a foreign language.
* [T2M-GPT](https://github.com/Mael-zys/T2M-GPT) ⭐ 775 | 🐛 18 | 🌐 Python | 📅 2024-09-17 - Generating human motion from textual descriptions with discrete representations.
...
* [VideoMAE V2](https://github.com/OpenGVLab/VideoMAEv2) ⭐ 817 | 🐛 25 | 🌐 Python | 📅 2024-10-08 - Billion-parameter video foundation model pretrained on millions of clips, finetunable for action recognition.
...
* [YOLO-Pose](https://github.com/ultralytics/ultralytics) ⭐ 61,132 | 🐛 86 | 🌐 Python | 📅 2026-08-31 - Ultralytics YOLOv8 Pose for real-time multi-person skeleton estimation.
* [OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,421 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - Real-time multi-person keypoint detection for skeleton extraction from video.
...
* [Awesome Video Understanding](https://github.com/HuaizhengZhang/Awesome-System-for-Machine-Learning) ⭐ 4,324 | 🐛 14 | 📅 2025-07-25 - Video understanding systems and architectures.
