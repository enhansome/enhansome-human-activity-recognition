...
* [PySlowFast](https://github.com/facebookresearch/SlowFast) ⭐ 7,418 | 🐛 444 | 🌐 Python | 📅 2026-03-16 - Facebook Research library for video understanding with SlowFast, X3D, MViT, and AVA models.
* [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,157 | 🐛 319 | 🌐 Python | 📅 2026-03-18 - OpenMMLab toolbox for video understanding supporting 20+ model architectures including SlowFast, TimeSformer, and VideoMAE.
...
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,444 | 🐛 250 | 🌐 Python | 📅 2026-09-09 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [SMPL-X](https://github.com/vchoutas/smplx) ⭐ 2,702 | 🐛 134 | 🌐 Python | 📅 2024-08-12 - Expressive body model capturing body, face, and hand poses, the standard for modern motion datasets.
...
* [YOLO-Pose](https://github.com/ultralytics/ultralytics) ⭐ 61,444 | 🐛 73 | 🌐 Python | 📅 2026-09-09 - Ultralytics YOLOv8 Pose for real-time multi-person skeleton estimation.
...
* [Awesome Self-Supervised Learning](https://github.com/jason718/awesome-self-supervised-learning) ⭐ 6,414 | 🐛 1 | 📅 2026-02-24 - Self-supervised learning methods applicable to video and sensor modalities.
* [Awesome Video Understanding](https://github.com/HuaizhengZhang/Awesome-System-for-Machine-Learning) ⭐ 4,349 | 🐛 14 | 📅 2025-07-25 - Video understanding systems and architectures.
...
* [Awesome Skeleton-based Action Recognition](https://github.com/firework8/Awesome-Skeleton-based-Action-Recognition) ⭐ 728 | 🐛 0 | 📅 2026-09-06 - GCN and transformer methods for skeleton HAR.
