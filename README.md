...
* [MotionBERT](https://github.com/Walter0807/MotionBERT) ⭐ 1,438 | 🐛 44 | 🌐 Python | 📅 2026-03-14 - Unified pretraining for human motion analysis covering 3D pose estimation and action recognition.
...
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,437 | 🐛 246 | 🌐 Python | 📅 2026-08-25 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [YOLO-Pose](https://github.com/ultralytics/ultralytics) ⭐ 60,952 | 🐛 92 | 🌐 Python | 📅 2026-08-25 - Ultralytics YOLOv8 Pose for real-time multi-person skeleton estimation.
* [OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,401 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - Real-time multi-person keypoint detection for skeleton extraction from video.
