...
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,445 | 🐛 243 | 🌐 Python | 📅 2026-09-20 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [YOLO-Pose](https://github.com/ultralytics/ultralytics) ⭐ 61,820 | 🐛 74 | 🌐 Python | 📅 2026-09-20 - Ultralytics YOLOv8 Pose for real-time multi-person skeleton estimation.
* [OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,457 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - Real-time multi-person keypoint detection for skeleton extraction from video.
...
* [Awesome Video Understanding](https://github.com/HuaizhengZhang/Awesome-System-for-Machine-Learning) ⭐ 4,388 | 🐛 14 | 📅 2025-07-25 - Video understanding systems and architectures.
...
* [Awesome Skeleton-based Action Recognition](https://github.com/firework8/Awesome-Skeleton-based-Action-Recognition) ⭐ 732 | 🐛 0 | 📅 2026-09-06 - GCN and transformer methods for skeleton HAR.
