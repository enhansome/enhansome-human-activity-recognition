...
* [InternVideo2](https://github.com/OpenGVLab/InternVideo2) ⭐ 528 | 🐛 11 | 🌐 Python | 📅 2026-07-19 - Foundation model for video understanding at scale supporting action recognition, retrieval, and captioning.
...
* [tsai](https://github.com/timeseriesAI/tsai) ⭐ 6,114 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2026-07-23 - Deep learning library for time series and sequences built on fastai and PyTorch, widely used for sensor HAR.
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,439 | 🐛 236 | 🌐 Python | 📅 2026-09-01 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [SMPL-X](https://github.com/vchoutas/smplx) ⭐ 2,693 | 🐛 134 | 🌐 Python | 📅 2024-08-12 - Expressive body model capturing body, face, and hand poses, the standard for modern motion datasets.
...
* [T2M-GPT](https://github.com/Mael-zys/T2M-GPT) ⭐ 776 | 🐛 18 | 🌐 Python | 📅 2024-09-17 - Generating human motion from textual descriptions with discrete representations.
...
* [YOLO-Pose](https://github.com/ultralytics/ultralytics) ⭐ 61,164 | 🐛 88 | 🌐 Python | 📅 2026-09-01 - Ultralytics YOLOv8 Pose for real-time multi-person skeleton estimation.
* [OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,419 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - Real-time multi-person keypoint detection for skeleton extraction from video.
...
* [Awesome Video Understanding](https://github.com/HuaizhengZhang/Awesome-System-for-Machine-Learning) ⭐ 4,327 | 🐛 14 | 📅 2025-07-25 - Video understanding systems and architectures.
