...
* [HumanML3D](https://github.com/EricGuo5513/HumanML3D) ⭐ 1,531 | 🐛 112 | 🌐 Python | 📅 2024-08-18 - Text-to-motion generation dataset with SMPL annotations spanning 14k+ motion sequences.
...
* [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,152 | 🐛 319 | 🌐 Python | 📅 2026-03-18 - OpenMMLab toolbox for video understanding supporting 20+ model architectures including SlowFast, TimeSformer, and VideoMAE.
...
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,444 | 🐛 250 | 🌐 Python | 📅 2026-09-08 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [VideoMAE V2](https://github.com/OpenGVLab/VideoMAEv2) ⭐ 818 | 🐛 25 | 🌐 Python | 📅 2024-10-08 - Billion-parameter video foundation model pretrained on millions of clips, finetunable for action recognition.
...
* [YOLO-Pose](https://github.com/ultralytics/ultralytics) ⭐ 61,406 | 🐛 71 | 🌐 Python | 📅 2026-09-08 - Ultralytics YOLOv8 Pose for real-time multi-person skeleton estimation.
* [OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,431 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - Real-time multi-person keypoint detection for skeleton extraction from video.
...
* [Awesome Video Understanding](https://github.com/HuaizhengZhang/Awesome-System-for-Machine-Learning) ⭐ 4,343 | 🐛 14 | 📅 2025-07-25 - Video understanding systems and architectures.
