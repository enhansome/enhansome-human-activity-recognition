...
* [HumanML3D](https://github.com/EricGuo5513/HumanML3D) ⭐ 1,529 | 🐛 112 | 🌐 Python | 📅 2024-08-18 - Text-to-motion generation dataset with SMPL annotations spanning 14k+ motion sequences.
...
* [VideoMAE](https://github.com/MCG-NJU/VideoMAE) ⭐ 1,789 | 🐛 50 | 🌐 Python | 📅 2023-12-08 - Self-supervised video pretraining with masked autoencoders achieving SOTA on multiple benchmarks.
...
* [MotionBERT](https://github.com/Walter0807/MotionBERT) ⭐ 1,442 | 🐛 44 | 🌐 Python | 📅 2026-03-14 - Unified pretraining for human motion analysis covering 3D pose estimation and action recognition.
...
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,443 | 🐛 244 | 🌐 Python | 📅 2026-09-04 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [MDM](https://github.com/GuyTevet/motion-diffusion-model) ⭐ 4,093 | 🐛 69 | 🌐 Python | 📅 2025-10-01 - Human motion diffusion model for text-to-motion generation achieving SOTA on HumanML3D.
* [SMPL-X](https://github.com/vchoutas/smplx) ⭐ 2,698 | 🐛 134 | 🌐 Python | 📅 2024-08-12 - Expressive body model capturing body, face, and hand poses, the standard for modern motion datasets.
...
* [YOLO-Pose](https://github.com/ultralytics/ultralytics) ⭐ 61,336 | 🐛 66 | 🌐 Python | 📅 2026-09-06 - Ultralytics YOLOv8 Pose for real-time multi-person skeleton estimation.
* [OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,427 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - Real-time multi-person keypoint detection for skeleton extraction from video.
...
* [Awesome Video Understanding](https://github.com/HuaizhengZhang/Awesome-System-for-Machine-Learning) ⭐ 4,338 | 🐛 14 | 📅 2025-07-25 - Video understanding systems and architectures.
