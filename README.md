...
* [VideoMAE](https://github.com/MCG-NJU/VideoMAE) ⭐ 1,791 | 🐛 50 | 🌐 Python | 📅 2023-12-08 - Self-supervised video pretraining with masked autoencoders achieving SOTA on multiple benchmarks.
...
* [MotionBERT](https://github.com/Walter0807/MotionBERT) ⭐ 1,444 | 🐛 44 | 🌐 Python | 📅 2026-03-14 - Unified pretraining for human motion analysis covering 3D pose estimation and action recognition.
...
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,444 | 🐛 254 | 🌐 Python | 📅 2026-09-10 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [MDM](https://github.com/GuyTevet/motion-diffusion-model) ⭐ 4,096 | 🐛 69 | 🌐 Python | 📅 2025-10-01 - Human motion diffusion model for text-to-motion generation achieving SOTA on HumanML3D.
* [SMPL-X](https://github.com/vchoutas/smplx) ⭐ 2,705 | 🐛 134 | 🌐 Python | 📅 2024-08-12 - Expressive body model capturing body, face, and hand poses, the standard for modern motion datasets.
...
* [YOLO-Pose](https://github.com/ultralytics/ultralytics) ⭐ 61,481 | 🐛 75 | 🌐 Python | 📅 2026-09-10 - Ultralytics YOLOv8 Pose for real-time multi-person skeleton estimation.
* [OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,435 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - Real-time multi-person keypoint detection for skeleton extraction from video.
...
* [Awesome Self-Supervised Learning](https://github.com/jason718/awesome-self-supervised-learning) ⭐ 6,414 | 🐛 2 | 📅 2026-02-24 - Self-supervised learning methods applicable to video and sensor modalities.
* [Awesome Video Understanding](https://github.com/HuaizhengZhang/Awesome-System-for-Machine-Learning) ⭐ 4,357 | 🐛 14 | 📅 2025-07-25 - Video understanding systems and architectures.
...
* [Awesome Skeleton-based Action Recognition](https://github.com/firework8/Awesome-Skeleton-based-Action-Recognition) ⭐ 729 | 🐛 0 | 📅 2026-09-06 - GCN and transformer methods for skeleton HAR.
* [Awesome IMU Sensing](https://github.com/rh20624/Awesome-IMU-Sensing) ⭐ 211 | 🐛 0 | 📅 2026-08-21 - IMU-based sensing for activity recognition and navigation.
