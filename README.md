...
* [PySlowFast](https://github.com/facebookresearch/SlowFast) ⭐ 7,412 | 🐛 444 | 🌐 Python | 📅 2026-03-16 - Facebook Research library for video understanding with SlowFast, X3D, MViT, and AVA models.
...
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,439 | 🐛 233 | 🌐 Python | 📅 2026-08-29 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [SMPL-X](https://github.com/vchoutas/smplx) ⭐ 2,688 | 🐛 134 | 🌐 Python | 📅 2024-08-12 - Expressive body model capturing body, face, and hand poses, the standard for modern motion datasets.
...
* [VideoMAE V2](https://github.com/OpenGVLab/VideoMAEv2) ⭐ 816 | 🐛 25 | 🌐 Python | 📅 2024-10-08 - Billion-parameter video foundation model pretrained on millions of clips, finetunable for action recognition.
...
* [YOLO-Pose](https://github.com/ultralytics/ultralytics) ⭐ 61,071 | 🐛 92 | 🌐 Python | 📅 2026-08-29 - Ultralytics YOLOv8 Pose for real-time multi-person skeleton estimation.
...
* [Awesome Video Understanding](https://github.com/HuaizhengZhang/Awesome-System-for-Machine-Learning) ⭐ 4,318 | 🐛 14 | 📅 2025-07-25 - Video understanding systems and architectures.
