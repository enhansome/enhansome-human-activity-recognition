...
* [PySlowFast](https://github.com/facebookresearch/SlowFast) ⭐ 7,420 | 🐛 444 | 🌐 Python | 📅 2026-03-16 - Facebook Research library for video understanding with SlowFast, X3D, MViT, and AVA models.
...
* [tsai](https://github.com/timeseriesAI/tsai) ⭐ 6,116 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2026-07-23 - Deep learning library for time series and sequences built on fastai and PyTorch, widely used for sensor HAR.
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,444 | 🐛 244 | 🌐 Python | 📅 2026-09-13 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [MotionGPT](https://github.com/OpenMotionLab/MotionGPT) ⭐ 1,970 | 🐛 72 | 🌐 Python | 📅 2025-07-01 - Unified motion-language generation model treating motion as a foreign language.
...
* [YOLO-Pose](https://github.com/ultralytics/ultralytics) ⭐ 61,557 | 🐛 80 | 🌐 Python | 📅 2026-09-13 - Ultralytics YOLOv8 Pose for real-time multi-person skeleton estimation.
* [OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,443 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - Real-time multi-person keypoint detection for skeleton extraction from video.
...
* [Awesome Video Understanding](https://github.com/HuaizhengZhang/Awesome-System-for-Machine-Learning) ⭐ 4,363 | 🐛 14 | 📅 2025-07-25 - Video understanding systems and architectures.
