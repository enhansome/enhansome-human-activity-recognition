...
* [HumanML3D](https://github.com/EricGuo5513/HumanML3D) ⭐ 1,522 | 🐛 112 | 🌐 Python | 📅 2024-08-18 - Text-to-motion generation dataset with SMPL annotations spanning 14k+ motion sequences.
...
* [PySlowFast](https://github.com/facebookresearch/SlowFast) ⭐ 7,413 | 🐛 444 | 🌐 Python | 📅 2026-03-16 - Facebook Research library for video understanding with SlowFast, X3D, MViT, and AVA models.
* [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,147 | 🐛 319 | 🌐 Python | 📅 2026-03-18 - OpenMMLab toolbox for video understanding supporting 20+ model architectures including SlowFast, TimeSformer, and VideoMAE.
...
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,439 | 🐛 234 | 🌐 Python | 📅 2026-08-29 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [SMPL-X](https://github.com/vchoutas/smplx) ⭐ 2,689 | 🐛 134 | 🌐 Python | 📅 2024-08-12 - Expressive body model capturing body, face, and hand poses, the standard for modern motion datasets.
...
* [YOLO-Pose](https://github.com/ultralytics/ultralytics) ⭐ 61,092 | 🐛 85 | 🌐 Python | 📅 2026-08-30 - Ultralytics YOLOv8 Pose for real-time multi-person skeleton estimation.
* [OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,420 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - Real-time multi-person keypoint detection for skeleton extraction from video.
...
* [Awesome Video Understanding](https://github.com/HuaizhengZhang/Awesome-System-for-Machine-Learning) ⭐ 4,323 | 🐛 14 | 📅 2025-07-25 - Video understanding systems and architectures.
