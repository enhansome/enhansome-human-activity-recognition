...
* [WEAR](https://github.com/mariusbock/wear) ⭐ 26 | 🐛 0 | 🌐 Python | 📅 2026-06-15 - Outdoor sports dataset with smartwatch IMU and egocentric video from 22 subjects across 18 activities, published at IMWUT 2024.
...
* [HumanML3D](https://github.com/EricGuo5513/HumanML3D) ⭐ 1,540 | 🐛 112 | 🌐 Python | 📅 2024-08-18 - Text-to-motion generation dataset with SMPL annotations spanning 14k+ motion sequences.
...
* [PySlowFast](https://github.com/facebookresearch/SlowFast) ⭐ 7,423 | 🐛 445 | 🌐 Python | 📅 2026-03-16 - Facebook Research library for video understanding with SlowFast, X3D, MViT, and AVA models.
* [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,162 | 🐛 319 | 🌐 Python | 📅 2026-03-18 - OpenMMLab toolbox for video understanding supporting 20+ model architectures including SlowFast, TimeSformer, and VideoMAE.
...
* [VideoMAE](https://github.com/MCG-NJU/VideoMAE) ⭐ 1,796 | 🐛 51 | 🌐 Python | 📅 2023-12-08 - Self-supervised video pretraining with masked autoencoders achieving SOTA on multiple benchmarks.
* [Video-Swin-Transformer](https://github.com/SwinTransformer/Video-Swin-Transformer) ⭐ 1,665 | 🐛 73 | 🌐 Python | 📅 2023-03-08 - Pure-transformer backbone for video recognition achieving SOTA on Kinetics-400, Kinetics-600, and SSv2.
...
* [ST-GCN](https://github.com/yysijie/st-gcn) ⭐ 1,759 | 🐛 0 | 🌐 Python | 📅 2023-03-08 - Seminal spatial-temporal graph convolution network that established the GCN approach for skeleton-based HAR.
* [MotionBERT](https://github.com/Walter0807/MotionBERT) ⭐ 1,451 | 🐛 45 | 🌐 Python | 📅 2026-03-14 - Unified pretraining for human motion analysis covering 3D pose estimation and action recognition.
...
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,447 | 🐛 253 | 🌐 Python | 📅 2026-09-22 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [MDM](https://github.com/GuyTevet/motion-diffusion-model) ⭐ 4,101 | 🐛 69 | 🌐 Python | 📅 2025-10-01 - Human motion diffusion model for text-to-motion generation achieving SOTA on HumanML3D.
* [SMPL-X](https://github.com/vchoutas/smplx) ⭐ 2,714 | 🐛 135 | 🌐 Python | 📅 2024-08-12 - Expressive body model capturing body, face, and hand poses, the standard for modern motion datasets.
...
* [VideoMAE V2](https://github.com/OpenGVLab/VideoMAEv2) ⭐ 822 | 🐛 26 | 🌐 Python | 📅 2024-10-08 - Billion-parameter video foundation model pretrained on millions of clips, finetunable for action recognition.
...
* [UAV-Human Challenge](https://github.com/SUTDCV/UAV-Human) ⭐ 259 | 🐛 12 | 🌐 Python | 📅 2022-07-11 - Human behavior understanding from UAV perspectives with multi-modal data.
...
* [YOLO-Pose](https://github.com/ultralytics/ultralytics) ⭐ 61,909 | 🐛 74 | 🌐 Python | 📅 2026-09-22 - Ultralytics YOLOv8 Pose for real-time multi-person skeleton estimation.
* [OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,464 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - Real-time multi-person keypoint detection for skeleton extraction from video.
* [Decord](https://github.com/dmlc/decord) ⭐ 2,522 | 🐛 221 | 🌐 C++ | 📅 2024-07-17 - Efficient GPU-accelerated video reader for deep learning training pipelines.
...
* [Awesome Self-Supervised Learning](https://github.com/jason718/awesome-self-supervised-learning) ⭐ 6,427 | 🐛 2 | 📅 2026-02-24 - Self-supervised learning methods applicable to video and sensor modalities.
* [Awesome Video Understanding](https://github.com/HuaizhengZhang/Awesome-System-for-Machine-Learning) ⭐ 4,393 | 🐛 14 | 📅 2025-07-25 - Video understanding systems and architectures.
* [Awesome Action Recognition](https://github.com/jinwchoi/awesome-action-recognition) ⭐ 4,032 | 🐛 1 | 📅 2023-05-13 - Action recognition papers and datasets.
...
* [Awesome Skeleton-based Action Recognition](https://github.com/firework8/Awesome-Skeleton-based-Action-Recognition) ⭐ 733 | 🐛 0 | 📅 2026-09-06 - GCN and transformer methods for skeleton HAR.
