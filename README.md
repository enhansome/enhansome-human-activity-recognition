...
* [HumanML3D](https://github.com/EricGuo5513/HumanML3D) ⭐ 1,528 | 🐛 112 | 🌐 Python | 📅 2024-08-18 - Text-to-motion generation dataset with SMPL annotations spanning 14k+ motion sequences.
...
* [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,151 | 🐛 319 | 🌐 Python | 📅 2026-03-18 - OpenMMLab toolbox for video understanding supporting 20+ model architectures including SlowFast, TimeSformer, and VideoMAE.
...
* [ST-GCN](https://github.com/yysijie/st-gcn) ⭐ 1,757 | 🐛 0 | 🌐 Python | 📅 2023-03-08 - Seminal spatial-temporal graph convolution network that established the GCN approach for skeleton-based HAR.
...
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,443 | 🐛 245 | 🌐 Python | 📅 2026-09-04 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [SMPL-X](https://github.com/vchoutas/smplx) ⭐ 2,696 | 🐛 134 | 🌐 Python | 📅 2024-08-12 - Expressive body model capturing body, face, and hand poses, the standard for modern motion datasets.
...
* [YOLO-Pose](https://github.com/ultralytics/ultralytics) ⭐ 61,313 | 🐛 86 | 🌐 Python | 📅 2026-09-05 - Ultralytics YOLOv8 Pose for real-time multi-person skeleton estimation.
* [OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,424 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - Real-time multi-person keypoint detection for skeleton extraction from video.
...
* [Awesome Video Understanding](https://github.com/HuaizhengZhang/Awesome-System-for-Machine-Learning) ⭐ 4,337 | 🐛 14 | 📅 2025-07-25 - Video understanding systems and architectures.
