...
* [EgoExo-Fitness](https://github.com/iSEE-Laboratory/EgoExo-Fitness) ⭐ 38 | 🐛 1 | 🌐 Python | 📅 2025-04-08 - Ego and exo fitness action quality assessment with 31 hours and 6k+ actions from ECCV 2024.

### Emerging and Frontier

* [HumanML3D](https://github.com/EricGuo5513/HumanML3D) ⭐ 1,519 | 🐛 112 | 🌐 Python | 📅 2024-08-18 - Text-to-motion generation dataset with SMPL annotations spanning 14k+ motion sequences.
...
* [PySlowFast](https://github.com/facebookresearch/SlowFast) ⭐ 7,405 | 🐛 444 | 🌐 Python | 📅 2026-03-16 - Facebook Research library for video understanding with SlowFast, X3D, MViT, and AVA models.
* [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,132 | 🐛 319 | 🌐 Python | 📅 2026-03-18 - OpenMMLab toolbox for video understanding supporting 20+ model architectures including SlowFast, TimeSformer, and VideoMAE.
...
* [InternVideo2](https://github.com/OpenGVLab/InternVideo2) ⭐ 527 | 🐛 10 | 🌐 Python | 📅 2026-07-19 - Foundation model for video understanding at scale supporting action recognition, retrieval, and captioning.
...
* [MotionBERT](https://github.com/Walter0807/MotionBERT) ⭐ 1,433 | 🐛 44 | 🌐 Python | 📅 2026-03-14 - Unified pretraining for human motion analysis covering 3D pose estimation and action recognition.
...
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,433 | 🐛 239 | 🌐 Python | 📅 2026-08-13 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [MDM](https://github.com/GuyTevet/motion-diffusion-model) ⭐ 4,086 | 🐛 69 | 🌐 Python | 📅 2025-10-01 - Human motion diffusion model for text-to-motion generation achieving SOTA on HumanML3D.
...
* [MLD](https://github.com/ChenFengYe/motion-latent-diffusion) ⭐ 745 | 🐛 39 | 🌐 Python | 📅 2023-07-11 - Motion latent diffusion model for efficient text-driven human motion generation from CVPR 2023.

## Pretrained Models

* [VideoMAE V2](https://github.com/OpenGVLab/VideoMAEv2) ⭐ 812 | 🐛 25 | 🌐 Python | 📅 2024-10-08 - Billion-parameter video foundation model pretrained on millions of clips, finetunable for action recognition.
...
* [MVD](https://github.com/ruiwang2021/mvd) ⭐ 135 | 🐛 3 | 🌐 Python | 📅 2023-05-21 - Masked video distillation pretrained model competitive with VideoMAE on downstream action recognition.
...
* [UAV-Human Challenge](https://github.com/SUTDCV/UAV-Human) ⭐ 254 | 🐛 12 | 🌐 Python | 📅 2022-07-11 - Human behavior understanding from UAV perspectives with multi-modal data.

## Tools and Utilities

* [YOLO-Pose](https://github.com/ultralytics/ultralytics) ⭐ 60,598 | 🐛 157 | 🌐 Python | 📅 2026-08-13 - Ultralytics YOLOv8 Pose for real-time multi-person skeleton estimation.
* [OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,362 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - Real-time multi-person keypoint detection for skeleton extraction from video.
...
* [Awesome Video Understanding](https://github.com/HuaizhengZhang/Awesome-System-for-Machine-Learning) ⭐ 4,272 | 🐛 14 | 📅 2025-07-25 - Video understanding systems and architectures.
* [Awesome Action Recognition](https://github.com/jinwchoi/awesome-action-recognition) ⭐ 4,011 | 🐛 1 | 📅 2023-05-13 - Action recognition papers and datasets.
...
* [Awesome Skeleton-based Action Recognition](https://github.com/firework8/Awesome-Skeleton-based-Action-Recognition) ⭐ 725 | 🐛 0 | 📅 2026-07-18 - GCN and transformer methods for skeleton HAR.
* [Awesome IMU Sensing](https://github.com/rh20624/Awesome-IMU-Sensing) ⭐ 205 | 🐛 0 | 📅 2026-07-27 - IMU-based sensing for activity recognition and navigation.
