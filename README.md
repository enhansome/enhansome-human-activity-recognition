...
* [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,145 | 🐛 319 | 🌐 Python | 📅 2026-03-18 - OpenMMLab toolbox for video understanding supporting 20+ model architectures including SlowFast, TimeSformer, and VideoMAE.
...
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,439 | 🐛 230 | 🌐 Python | 📅 2026-08-28 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [SMPL-X](https://github.com/vchoutas/smplx) ⭐ 2,687 | 🐛 134 | 🌐 Python | 📅 2024-08-12 - Expressive body model capturing body, face, and hand poses, the standard for modern motion datasets.
