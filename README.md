...
* [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,137 | 🐛 319 | 🌐 Python | 📅 2026-03-18 - OpenMMLab toolbox for video understanding supporting 20+ model architectures including SlowFast, TimeSformer, and VideoMAE.
...
* [VideoMAE](https://github.com/MCG-NJU/VideoMAE) ⭐ 1,781 | 🐛 50 | 🌐 Python | 📅 2023-12-08 - Self-supervised video pretraining with masked autoencoders achieving SOTA on multiple benchmarks.
...
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,435 | 🐛 242 | 🌐 Python | 📅 2026-08-15 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [VideoMAE V2](https://github.com/OpenGVLab/VideoMAEv2) ⭐ 813 | 🐛 25 | 🌐 Python | 📅 2024-10-08 - Billion-parameter video foundation model pretrained on millions of clips, finetunable for action recognition.
...
* [YOLO-Pose](https://github.com/ultralytics/ultralytics) ⭐ 60,662 | 🐛 163 | 🌐 Python | 📅 2026-08-16 - Ultralytics YOLOv8 Pose for real-time multi-person skeleton estimation.
...
* [Awesome Video Understanding](https://github.com/HuaizhengZhang/Awesome-System-for-Machine-Learning) ⭐ 4,282 | 🐛 14 | 📅 2025-07-25 - Video understanding systems and architectures.
