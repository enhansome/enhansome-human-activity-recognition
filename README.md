...
* [CAPTURE-24](https://github.com/OxWearables/capture24) ⭐ 60 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2024-11-19 - Largest free-living wrist accelerometer dataset with 151 subjects and 3883 hours from Nature Scientific Data 2024.
...
* [HumanML3D](https://github.com/EricGuo5513/HumanML3D) ⭐ 1,533 | 🐛 112 | 🌐 Python | 📅 2024-08-18 - Text-to-motion generation dataset with SMPL annotations spanning 14k+ motion sequences.
...
* [PySlowFast](https://github.com/facebookresearch/SlowFast) ⭐ 7,421 | 🐛 445 | 🌐 Python | 📅 2026-03-16 - Facebook Research library for video understanding with SlowFast, X3D, MViT, and AVA models.
* [MMAction2](https://github.com/open-mmlab/mmaction2) ⭐ 5,159 | 🐛 319 | 🌐 Python | 📅 2026-03-18 - OpenMMLab toolbox for video understanding supporting 20+ model architectures including SlowFast, TimeSformer, and VideoMAE.
...
* [VideoMAE](https://github.com/MCG-NJU/VideoMAE) ⭐ 1,794 | 🐛 51 | 🌐 Python | 📅 2023-12-08 - Self-supervised video pretraining with masked autoencoders achieving SOTA on multiple benchmarks.
* [Video-Swin-Transformer](https://github.com/SwinTransformer/Video-Swin-Transformer) ⭐ 1,664 | 🐛 73 | 🌐 Python | 📅 2023-03-08 - Pure-transformer backbone for video recognition achieving SOTA on Kinetics-400, Kinetics-600, and SSv2.
* [InternVideo2](https://github.com/OpenGVLab/InternVideo2) ⭐ 530 | 🐛 11 | 🌐 Python | 📅 2026-07-19 - Foundation model for video understanding at scale supporting action recognition, retrieval, and captioning.

### Skeleton Action Recognition

* [ST-GCN](https://github.com/yysijie/st-gcn) ⭐ 1,758 | 🐛 0 | 🌐 Python | 📅 2023-03-08 - Seminal spatial-temporal graph convolution network that established the GCN approach for skeleton-based HAR.
* [MotionBERT](https://github.com/Walter0807/MotionBERT) ⭐ 1,447 | 🐛 45 | 🌐 Python | 📅 2026-03-14 - Unified pretraining for human motion analysis covering 3D pose estimation and action recognition.
...
* [tsai](https://github.com/timeseriesAI/tsai) ⭐ 6,118 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2026-07-23 - Deep learning library for time series and sequences built on fastai and PyTorch, widely used for sensor HAR.
* [aeon](https://github.com/aeon-toolkit/aeon) ⭐ 1,444 | 🐛 245 | 🌐 Python | 📅 2026-09-14 - Unified Python toolkit for time series including classification, clustering, and anomaly detection.
...
* [MDM](https://github.com/GuyTevet/motion-diffusion-model) ⭐ 4,097 | 🐛 69 | 🌐 Python | 📅 2025-10-01 - Human motion diffusion model for text-to-motion generation achieving SOTA on HumanML3D.
* [SMPL-X](https://github.com/vchoutas/smplx) ⭐ 2,706 | 🐛 135 | 🌐 Python | 📅 2024-08-12 - Expressive body model capturing body, face, and hand poses, the standard for modern motion datasets.
* [MotionGPT](https://github.com/OpenMotionLab/MotionGPT) ⭐ 1,971 | 🐛 72 | 🌐 Python | 📅 2025-07-01 - Unified motion-language generation model treating motion as a foreign language.
...
* [VideoMAE V2](https://github.com/OpenGVLab/VideoMAEv2) ⭐ 819 | 🐛 26 | 🌐 Python | 📅 2024-10-08 - Billion-parameter video foundation model pretrained on millions of clips, finetunable for action recognition.
* [UniFormerV2](https://github.com/OpenGVLab/UniFormerV2) ⭐ 353 | 🐛 18 | 🌐 Python | 📅 2024-04-02 - Efficient video transformer with multi-scale tokens achieving 90.0% top-1 on Kinetics-400.
* [MVD](https://github.com/ruiwang2021/mvd) ⭐ 137 | 🐛 3 | 🌐 Python | 📅 2023-05-21 - Masked video distillation pretrained model competitive with VideoMAE on downstream action recognition.
...
* [UAV-Human Challenge](https://github.com/SUTDCV/UAV-Human) ⭐ 256 | 🐛 12 | 🌐 Python | 📅 2022-07-11 - Human behavior understanding from UAV perspectives with multi-modal data.
...
* [YOLO-Pose](https://github.com/ultralytics/ultralytics) ⭐ 61,592 | 🐛 74 | 🌐 Python | 📅 2026-09-14 - Ultralytics YOLOv8 Pose for real-time multi-person skeleton estimation.
* [OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) ⭐ 34,444 | 🐛 359 | 🌐 C++ | 📅 2024-08-03 - Real-time multi-person keypoint detection for skeleton extraction from video.
* [Decord](https://github.com/dmlc/decord) ⭐ 2,518 | 🐛 221 | 🌐 C++ | 📅 2024-07-17 - Efficient GPU-accelerated video reader for deep learning training pipelines.
...
* [Awesome Self-Supervised Learning](https://github.com/jason718/awesome-self-supervised-learning) ⭐ 6,416 | 🐛 2 | 📅 2026-02-24 - Self-supervised learning methods applicable to video and sensor modalities.
* [Awesome Video Understanding](https://github.com/HuaizhengZhang/Awesome-System-for-Machine-Learning) ⭐ 4,368 | 🐛 14 | 📅 2025-07-25 - Video understanding systems and architectures.
...
* [Awesome Pose Estimation](https://github.com/cbsudux/awesome-human-pose-estimation) ⭐ 2,479 | 🐛 7 | 📅 2022-10-12 - Human pose estimation methods and benchmarks.
* [Awesome Skeleton-based Action Recognition](https://github.com/firework8/Awesome-Skeleton-based-Action-Recognition) ⭐ 730 | 🐛 0 | 📅 2026-09-06 - GCN and transformer methods for skeleton HAR.
* [Awesome IMU Sensing](https://github.com/rh20624/Awesome-IMU-Sensing) ⭐ 211 | 🐛 1 | 📅 2026-09-11 - IMU-based sensing for activity recognition and navigation.
